...
import kotlinx.android.synthetic.main.fragment_ingredients_framgment.view.*
...
class IngredientsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ingredients_framgment, container, false)
